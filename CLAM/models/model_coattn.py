...
class MCAT_Surv(nn.Module):
    def __init__(self, fusion='concat', omic_sizes=[1,2,33,14,14,89], n_classes=2,
                 model_size_wsi: str='small', model_size_omic: str='small', dropout=0.25, embed_dim=384, subtyping=True, k_sample=8, size_arg='small', instance_loss_fn=nn.CrossEntropyLoss()):
        
        super(MCAT_Surv, self).__init__()
        self.fusion = fusion
        self.omic_sizes = omic_sizes
        self.n_classes = n_classes
        self.size_dict_WSI = {"small": [embed_dim, 256, 256], "big": [embed_dim, 512, 384]}
    ...
    def forward(self,h):
        ...
        return logits, Y_prob, Y_hat, None, attention_scores
